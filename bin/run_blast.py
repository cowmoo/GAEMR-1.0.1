...
parser.add_option('--mito', '-i', action="store_true", default=False, dest="mito_screen",
    help='Run blastn tuned for detecting mitochondrial contamination (default=%default)')
