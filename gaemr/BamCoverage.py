...
class BamCoverage():
    ...
    def __set_coeff_var(self,coverage_list=None,coeff_var=None):
        if coverage_list:
            self.coeff_var = "%.3f" % scipy.stats.variation(coverage_list)
        if coeff_var:
    ...
    def __set_coverage_stats(self,coverage_list):
        ...
        self.__set_coeff_var(coverage_list)
