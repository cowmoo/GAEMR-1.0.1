...
class Site:
    ...
    #start here
    def __init__(self, assembly_name, gaemr_dir, site_subdir='html', home_base=None, organism_name=None):
        """initialize class"""
    ...
    def get_gaemr_summary(self):
        ...
        ref_vs_assembly_image=self.__find_single_file_that_look_like_this__('../work/' + '*.ref_vs_assembly.png')#
    ...
    def get_section_reference_analysis(self):
        ...
        if not self.__find_files_that_look_like_this__('../work/' + '*.ref_vs_assembly.png'):
            return None
    ...
    def get_assembly_analysis_title_html(self):
        ...
        if self.organism_name:
            title_assembly_name += ' (' + self.organism_name + ')'
        if self.home_base:
            title_assembly_name = '<a href="javascript:goTo(' + "'"+ self.home_base + "'" +');"/>' + title_assembly_name + '</a>'
